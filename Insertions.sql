...
--1
insert into circuitsmonuments values(1,74,1);
--2
insert into circuitsmonuments values(2,74,2);
--3
insert into circuitsmonuments values(3,74,3);
--4
insert into circuitsmonuments values(4,74,4);
--5
insert into circuitsmonuments values(5,74,5);

--6
insert into circuitsmonuments values(3,75,1);
--7
insert into circuitsmonuments values(4,75,2);
--8
insert into circuitsmonuments values(5,75,3);
--9
insert into circuitsmonuments values(6,75,4);
--10
insert into circuitsmonuments values(7,75,5);

--11
insert into circuitsmonuments values(6,76,1);
--12
insert into circuitsmonuments values(7,76,2);
--13
insert into circuitsmonuments values(8,76,3);
--14
insert into circuitsmonuments values(9,76,4);
--15
insert into circuitsmonuments values(10,76,5);

--16
insert into circuitsmonuments values(10,77,1);
--17
insert into circuitsmonuments values(11,77,2);
--18
insert into circuitsmonuments values(12,77,3);
--19
insert into circuitsmonuments values(13,77,4);
--20
insert into circuitsmonuments values(14,77,5);

--21
insert into circuitsmonuments values(3,78,1);
--22
insert into circuitsmonuments values(4,78,2);
--23
insert into circuitsmonuments values(8,78,3);
--24
insert into circuitsmonuments values(9,78,4);
--25
insert into circuitsmonuments values(15,78,5);
